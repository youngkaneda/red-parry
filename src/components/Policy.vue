<template>
    <div style="margin-left: 15px">
        ...
        <ul>
            ...
            <li>
                <p>
                    <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to red parry.
                </p>
            </li>
            <li>
            ...
            <li>
                <strong>Website</strong> refers to red parry, accessible from http://redparry.herokuapp.com/
            </li>
            <li>
        ...
        <ul>
            <li>By email: juanpablolvl99@gmail.com</li>
        </ul>
    </div>
</template>
